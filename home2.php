...
<html>
  ...
  <label for="tanggalL" class="col-sm-2 col-form-label ">Tanggal Lahir</label>
    <div class="col-sm-10">
      <input type="date" name="tanggalL" class="form-control <?php echo($error_tanggalL !="" ? "is-invalid" : "");?>" 
  ...
  <label for="telp" class="col-sm-2 col-form-label ">Nomor Telepon</label>
    <div class="col-sm-10">
      ...
      id="telp" placeholder="Nomor Telepon" value="<?php echo $telp; ?>">
  ...
  <div class="form-group row">
    <div class="col-sm-10">
     <button type="submit" name="Submit" class="btn btn-primary" style="color:black;">Submit</button>
    </div>
  </div>
  ...
  if(isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO pribadi (nik,nama,jk,nisn,tempatL,tanggalL,agama,khusus,alamat,rt,rw,dusun,desa,kecamatan,kode,tempatT,
    transpor,hp,telp,email,penerima_KPS,no_KPS,kwn,negara) VALUES ('$nik','$nama','$jk','$nisn',' $tempatL','$tanggalL','$agama'
    ,'$khusus','$alamat','$rt','$rw','$dusun','$desa','$kecamatan','$kode','$tempatT','$transpor','$hp','$telp','$email','$penerima_KPS'
    ,'$no_KPS','$kwn','$negara')";
