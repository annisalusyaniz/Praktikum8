...
<html>
  ...
  <div class="form-group row">
    ...
    <button type="submit" name="Submit" class="btn btn-primary" style="color:black;">Submit</button>
     <button type="next" name="next" class="btn btn-primary"><a href="home2.php" style="color:black; text-decoration:none">Next</button>
    </div>
  </div>
  ...
  if(isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO peserta (jp,tanggal,nis,no_ujian,paud,tk,skhun,ijazah,hobi,cita) VALUES ('$jp','$tanggal','$nis','$no_ujian','$paud'
    ,'$tk','$skhun','$ijazah','$hobi','$cita')";
