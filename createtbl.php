<?php 
  ...
  if (mysqli_query($conn, $sql_peserta)) {
      echo "Table peserta Create Successfully";
  } else {
      echo "Table peserta Creating Failed: " . mysqli_error($conn);
  }
...
if (mysqli_query($conn, $sql)) {
    echo "Table pribadi Created Successfully"; 
} else {
    echo "Table pribadi Creating Failed: " . mysqli_error($conn);
}
  mysqli_close($conn);
?>